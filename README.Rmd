...
Importantly, these are _business dates_. Generally, that means that there won't be any weekend values, and holidays are observed and also won't generate any values. In this data set, `02/16 - 02/17` is a weekend, and `02/18` is Valentine's Day.
